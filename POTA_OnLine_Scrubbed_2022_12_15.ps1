...
$WatchList = Import-Csv -Path $WatchList_File
$CRLF = "`r`n"
$Launch_Excel = $False
...
#     Email information
####
$From = "<SomeGmailEmailMailbox>@gmail.com"
$PW = "<Password>"
$To = "<Target Email mailbox>@someemail.com"
$SMS_Address = '<smsPhoneNumber>@txt.att.net'
$global:SMS_Body = ''
...
foreach ($PotaTable_Row in $PotaTable) {
    ...
    foreach ($WatchList_Row in $WatchList) {
        ...
        if ($WatchList_Row.Band -eq $CurrentBand -or $WatchList_Row.Band -eq '*') {
        ...
        if ($FoundSpot1 -and $FoundSpot2 -and $FoundSpot3 -and $FoundSpot4 -and $FoundSpot5 -and $FoundSpot6 -and !$FoundQRT) {
            ...
            #
            elseif ($global:QSOs -and $Global:QSO.fldOther2 -ne $PotaTable_Row.reference) {
